...
public class TopButtons {
    public enum ButtonsName {
        UPDATE, DELETE, INFO, OPEN, OPEN_LOCAL, DOWNLOAD, UPLOAD;
    }
    ...
    public TopButtons() {
        ...
        buttons.add(createButton(ButtonsName.DOWNLOAD.toString(), true));
        buttons.add(createButton(ButtonsName.UPLOAD.toString(), true));
    }
